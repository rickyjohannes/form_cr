...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function applySingleSelectionByContainer(containerId, groupName) {
        const container = document.getElementById(containerId);
        if (!container) return;

        container.addEventListener("change", function (event) {
            if (event.target.matches(`input[name^="${groupName}"]`)) {
    ...
    // Terapkan pada Jenis Permintaan (tanpa container khusus)
    applySingleSelectionByName("status_barang");
