...
class Proposal extends Model
{
    ...
    protected $fillable = ['no_transaksi', 'user_id', 'user_request', 'user_status', 'departement', 'ext_phone', 'status_barang', 'facility', 'user_note', 'it_analys','file','file_it','no_asset', 'status_dh','actiondate_dh','status_divh','actiondate_divh','status_cr','token'];
